...
class Config:
    ...
    GEMINI_IMAGE_429_FALLBACK_ENABLED: bool = _env_flag("GEMINI_IMAGE_429_FALLBACK_ENABLED", default=True)
    OPENAI_IMAGE_FALLBACK_ENABLED: bool = _env_flag("OPENAI_IMAGE_FALLBACK_ENABLED", default=False)
    ...
    IMAGE_GENERATION_BORDER_CHECK_ENABLED: bool = _env_flag("IMAGE_GENERATION_BORDER_CHECK_ENABLED", default=True)
    IMAGE_GENERATION_ASPECT_RATIO: str = os.getenv("IMAGE_GENERATION_ASPECT_RATIO", "3:4")
    IMAGE_GENERATION_SIZE: str = os.getenv("IMAGE_GENERATION_SIZE", "2K")
    IMAGE_RESPONSE_SIZE: int = int(os.getenv("IMAGE_RESPONSE_SIZE", "500"))  # Legacy fallback (square)
    IMAGE_RESPONSE_WIDTH: int = int(os.getenv("IMAGE_RESPONSE_WIDTH", str(IMAGE_RESPONSE_SIZE)))
    IMAGE_RESPONSE_HEIGHT: int = int(os.getenv("IMAGE_RESPONSE_HEIGHT", str(IMAGE_RESPONSE_SIZE)))
    STORY_IMAGE_RESPONSE_WIDTH: int = int(os.getenv("STORY_IMAGE_RESPONSE_WIDTH", "1050"))
    STORY_IMAGE_RESPONSE_HEIGHT: int = int(os.getenv("STORY_IMAGE_RESPONSE_HEIGHT", "1400"))
    COVER_IMAGE_RESPONSE_WIDTH: int = int(os.getenv("COVER_IMAGE_RESPONSE_WIDTH", str(STORY_IMAGE_RESPONSE_WIDTH)))
    COVER_IMAGE_RESPONSE_HEIGHT: int = int(os.getenv("COVER_IMAGE_RESPONSE_HEIGHT", str(STORY_IMAGE_RESPONSE_HEIGHT)))
    CHARACTER_REFERENCE_IMAGE_RESPONSE_SIZE: int = int(os.getenv("CHARACTER_REFERENCE_IMAGE_RESPONSE_SIZE", "768"))
