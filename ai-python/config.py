...
class Config:
    ...
    STORY_IMAGE_RESPONSE_WIDTH: int = int(os.getenv("STORY_IMAGE_RESPONSE_WIDTH", str(IMAGE_RESPONSE_WIDTH)))
    STORY_IMAGE_RESPONSE_HEIGHT: int = int(os.getenv("STORY_IMAGE_RESPONSE_HEIGHT", str(IMAGE_RESPONSE_HEIGHT)))
