...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> refresh(
        ...
        if (user.isDeleted() || (user.getStatus() != null && user.getStatus() != com.jaramgle.backend.entity.UserStatus.ACTIVE)) {
            return ResponseEntity.status(401).body(Collections.singletonMap("message", "Inactive user"));
        }
