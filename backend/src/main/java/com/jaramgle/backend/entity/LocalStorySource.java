...
@Entity
@Table(
        name = "local_story_sources",
        uniqueConstraints = @UniqueConstraint(
                name = "uk_local_story_sources_region_external",
                columnNames = {"region_code", "external_source", "external_id"}
        )
)
@Getter
@Setter
@NoArgsConstructor
public class LocalStorySource {
    ...
    @Column(name = "content_type_id", length = 40)
