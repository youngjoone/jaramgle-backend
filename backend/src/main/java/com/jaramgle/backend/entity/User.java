...
public class User {
    ...
    @Builder
    public User(String name, String email, String passwordHash, String provider, String providerId, String role, LocalDateTime createdAt, UserStatus status, boolean deleted) {
        this.name = name;
        this.email = email;
