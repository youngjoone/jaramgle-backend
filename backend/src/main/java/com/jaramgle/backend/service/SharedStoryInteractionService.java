...
import com.jaramgle.backend.dto.StoryLikeStatusDto;
import com.jaramgle.backend.dto.UpdateSharedStoryCommentRequest;
import com.jaramgle.backend.entity.SharedStory;
import com.jaramgle.backend.entity.SharedStoryComment;
import com.jaramgle.backend.entity.SharedStoryCommentLike;
import com.jaramgle.backend.entity.SharedStoryLike;
import com.jaramgle.backend.entity.User;
import com.jaramgle.backend.repository.SharedStoryCommentLikeRepository;
...
public class SharedStoryInteractionService {
    ...
    private SharedStory getSharedStoryBySlug(String shareSlug) {
        SharedStory sharedStory = sharedStoryRepository.findByShareSlugAndHiddenFalse(shareSlug)
                .orElseThrow(() -> new IllegalArgumentException("Shared story not found"));
        if (sharedStory.getStory() != null && (sharedStory.getStory().isDeleted() || sharedStory.getStory().isHidden())) {
